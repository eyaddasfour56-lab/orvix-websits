...
type Customer = { name?: string; phone?: string; totalSpent?: number; totalOrders?: number; cancelledOrders?: number; segment?: string; lastOrderAt?: string };
type Inventory = { id: string; product_name?: string; stock_quantity?: number; low_stock_limit?: number; reorderSuggested?: number };
